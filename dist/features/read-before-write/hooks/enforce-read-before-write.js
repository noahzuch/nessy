...
import { matchRules, unionRequires } from "../../../features/read-before-write/lib/matching.js";
import { cachePathFor, loadCache } from "../../../features/read-before-write/lib/cache.js";
import { checkStaleness } from "../../../features/read-before-write/lib/staleness.js";
import { log } from "../../../shared/log.js";
import { normalize } from "../../../shared/paths.js";
import { runHook } from "../../../shared/run-hook.js";
runHook("enforce-read-before-write", WriteEditHookPayloadSchema, { requiresProject: true, requiresConfig: true }, ({ payload, projectRoot, cfg }) => {
    ...
    for (const req of required) {
        ...
        if (s === "missing")
            issues.push({ path: req, status: "config-error" });
        else if (s === "stale")
            issues.push({ path: req, status: "stale" });
    }
    if (issues.length === 0)
        return;
...
//# sourceMappingURL=enforce-read-before-write.js.map